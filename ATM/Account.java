    ...
    public void changeMobileNumber() {
        try {
            ...
            if(enteredPin == getPinNumber()) {
                ...
                System.out.println("Incorrect PIN. Mobile number change failed.");
            }
        } catch (Exception e) {
            System.out.println("Invalid input. Only numbers allowed for mobile number and PIN.");
